...
class XD_ImportFBX(bpy.types.Operator, ImportHelper):
    """Load a FBX file"""
    bl_idname = "xd_import_scene.fbx"
    bl_label = "Import FBX"
    ...
    filename_ext = ".fbx"
    filter_glob: StringProperty(default="*.fbx", options={'HIDDEN'}) # type: ignore
...
@orientation_helper(axis_forward='-Z', axis_up='Y')
class XD_ExportFBX(bpy.types.Operator, ExportHelper):
    """Write a FBX file"""
    bl_idname = "xd_export_scene.fbx"
    bl_label = "Export FBX"
    bl_options = {'UNDO', 'PRESET'}
...
class XD_IO_FH_fbx(bpy.types.FileHandler):
    bl_idname = "XD_IO_FH_fbx"
    bl_label = "XDevs FBX"
    #bl_import_operator = "xd_import_scene.fbx"
    bl_export_operator = "xd_export_scene.fbx"
...
#     self.layout.operator(XD_ImportFBX.bl_idname, text="FBX (.fbx)")


def menu_func_export(self, context):
    self.layout.operator(XD_ExportFBX.bl_idname, text="XDevs FBX (.fbx)")
